...
const copy = {
  ...
  es: { role:"Bailarina · Coreógrafa · Artista aérea · Artista circense · Docente", title:<>El cuerpo sabe.<br/><em>Aprendamos a escucharlo.</em></>, lede:"El movimiento es un puente entre arte, educación y comunidad: un diálogo entre cuerpo, percepción y entorno que abre posibilidades de expresión, fuerza y libertad.", paths:"Descubre los programas", about:"Conoce a Alexandra", seal:<>Disciplina<br/>conciencia<br/>arte al servicio<br/>del cuerpo</>, index:"Movimiento y bienestar", image:"Bailarina contemporánea en movimiento en un estudio luminoso" },
};
